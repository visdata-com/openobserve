...
/// Format: "resource:{org_id}_{resource_type}_{entity_id}"
pub fn resource_object(org_id: &str, resource_type: &str, entity_id: &str) -> String {
    format!("resource:{}_{}_{}", org_id, resource_type, entity_id)
}

/// Generate "all org" resource object name
/// Format: "resource:{org_id}_{resource_type}_all"
pub fn resource_object_all(org_id: &str, resource_type: &str) -> String {
    format!("resource:{}_{}_all", org_id, resource_type)
}
...
mod tests {
    ...
    fn test_type_generation() {
        ...
        assert_eq!(
            ...
            "resource:default_logs_my_stream"
        );
    }
}
