...
pub async fn update_role(
    ...
    log::info!(
        "[RBAC] visdata_fga::update_role called: org_id={}, role_id={}, add_count={}, remove_count={}",
        org_id, role_id, update_role.add.len(), update_role.remove.len()
    );
    for perm in &update_role.add {
        log::info!("[RBAC] add perm: object={}, permission={}", perm.object, perm.permission);
    }
