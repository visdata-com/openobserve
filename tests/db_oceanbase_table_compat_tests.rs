...
//! ```bash
//! # Run all tests with OceanBase backend (requires db-oceanbase-tests feature)
//! ZO_TEST_OCEANBASE_DSN="mysql://root@127.0.0.1:2881/openobserve_test" ZO_NATS_ADDR="127.0.0.1:4222" \
//! cargo test --test db_oceanbase_table_compat_tests --features db-oceanbase-tests -- --test-threads=1 --nocapture
//!
//! # Run a single test (--test-threads=1 is optional for single tests)
//! ZO_TEST_OCEANBASE_DSN="mysql://root@127.0.0.1:2881/openobserve_test" ZO_NATS_ADDR="127.0.0.1:4222" \
//! cargo test --test db_oceanbase_table_compat_tests --features db-oceanbase-tests test_oceanbase_organizations_compat -- --test-threads=1 --nocapture
//! ```
...
/// Test organizations table compatibility with OceanBase
/// Order: 01, Dependencies: None
#[test]
fn test_oceanbase_organizations_compat() {
...
/// Test users table compatibility with OceanBase
/// Order: 02, Dependencies: None
#[test]
fn test_oceanbase_users_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test templates table compatibility with OceanBase
/// Order: 03, Dependencies: None
#[test]
fn test_oceanbase_templates_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test short_urls table compatibility with OceanBase
/// Order: 04, Dependencies: None
#[test]
fn test_oceanbase_short_urls_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test sessions table compatibility with OceanBase
/// Order: 05, Dependencies: None
#[test]
fn test_oceanbase_sessions_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test system_prompts table compatibility with OceanBase
/// Order: 06, Dependencies: None
#[test]
fn test_oceanbase_system_prompts_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test distinct_value_fields table compatibility with OceanBase
/// Order: 07, Dependencies: None
#[test]
fn test_oceanbase_distinct_values_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test org_users table compatibility with OceanBase
/// Order: 10, Dependencies: organizations, users
#[test]
fn test_oceanbase_org_users_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test folders table compatibility with OceanBase
/// Order: 11, Dependencies: organizations
#[test]
fn test_oceanbase_folders_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test destinations table compatibility with OceanBase
/// Order: 12, Dependencies: organizations, templates
#[test]
fn test_oceanbase_destinations_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test alerts table compatibility with OceanBase
/// Order: 20, Dependencies: organizations, folders, templates, destinations
#[test]
fn test_oceanbase_alerts_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test dashboards table compatibility with OceanBase
/// Order: 21, Dependencies: organizations, folders
#[test]
fn test_oceanbase_dashboards_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test file_list table compatibility with OceanBase
/// Order: 20, Dependencies: None (independent infrastructure)
#[test]
fn test_oceanbase_file_list_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test stream_stats table compatibility with OceanBase
/// Order: 21, Dependencies: None (independent infrastructure)
#[test]
fn test_oceanbase_stream_stats_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test file_list_deleted table compatibility with OceanBase
/// Order: 32, Dependencies: None (independent infrastructure)
#[test]
fn test_oceanbase_file_list_deleted_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_deleted_concurrent_query_deleted() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_deleted_lock_serialization() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_deleted_concurrent_counter() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test file_list_jobs table compatibility with OceanBase
/// Order: 33, Dependencies: None (independent infrastructure)
#[test]
fn test_oceanbase_file_list_jobs_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_jobs_concurrent_get_pending() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_jobs_concurrent_get_dump_jobs() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_file_list_jobs_lock_serialization() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test scheduled_jobs table compatibility with OceanBase
/// Order: 34, Dependencies: None
#[test]
fn test_oceanbase_scheduled_jobs_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_scheduled_jobs_concurrent_pull() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
#[test]
fn test_oceanbase_scheduled_jobs_pull_lock_serialization() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test cipher_keys table compatibility with OceanBase
/// Order: 40, Dependencies: None
#[test]
fn test_oceanbase_cipher_keys_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test system_settings table compatibility with OceanBase
/// Order: 41, Dependencies: None
#[test]
fn test_oceanbase_system_settings_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test action_scripts table compatibility with OceanBase
/// Order: 42, Dependencies: None
#[test]
fn test_oceanbase_action_scripts_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test enrichment_tables table compatibility with OceanBase
/// Order: 43, Dependencies: None
#[test]
fn test_oceanbase_enrichment_tables_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test enrichment_table_urls table compatibility with OceanBase
/// Order: 44, Dependencies: None
#[test]
fn test_oceanbase_enrichment_table_urls_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test rate_limit_rules table compatibility with OceanBase
/// Order: 45, Dependencies: None
#[test]
fn test_oceanbase_rate_limit_rules_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test re_patterns table compatibility with OceanBase
/// Order: 46, Dependencies: None
#[test]
fn test_oceanbase_re_patterns_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test re_pattern_stream_map table compatibility with OceanBase
/// Order: 47, Dependencies: re_patterns
#[test]
fn test_oceanbase_re_pattern_stream_map_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test service_streams table compatibility with OceanBase
/// Order: 48, Dependencies: None
#[test]
fn test_oceanbase_service_streams_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test service_streams_dimensions table compatibility with OceanBase
/// Order: 49, Dependencies: None
#[test]
fn test_oceanbase_service_streams_dimensions_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test search_queue table compatibility with OceanBase
/// Order: 50, Dependencies: None
#[test]
fn test_oceanbase_search_queue_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test compactor_manual_jobs table compatibility with OceanBase
/// Order: 51, Dependencies: None
#[test]
fn test_oceanbase_compactor_manual_jobs_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test alert_incidents table compatibility with OceanBase
/// Order: 52, Dependencies: organizations
#[test]
fn test_oceanbase_alert_incidents_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test file_list_dump_stats table compatibility with OceanBase
/// Order: 53, Dependencies: None (file_list infrastructure)
#[test]
fn test_oceanbase_file_list_dump_stats_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test schema_history table compatibility with OceanBase
/// Order: 54, Dependencies: None
#[test]
fn test_oceanbase_schema_history_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test reports table compatibility with OceanBase
/// Order: 55, Dependencies: organizations
#[test]
fn test_oceanbase_reports_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test timed_annotations table compatibility with OceanBase
/// Order: 56, Dependencies: organizations
#[test]
fn test_oceanbase_timed_annotations_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test timed_annotation_panels table compatibility with OceanBase
/// Order: 57, Dependencies: timed_annotations
#[test]
fn test_oceanbase_timed_annotation_panels_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test search_jobs table compatibility with OceanBase
/// Order: 58, Dependencies: organizations
#[test]
fn test_oceanbase_search_jobs_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test search_job_partitions table compatibility with OceanBase
/// Order: 59, Dependencies: search_jobs
#[test]
fn test_oceanbase_search_job_partitions_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test search_job_results table compatibility with OceanBase
/// Order: 60, Dependencies: search_jobs
#[test]
fn test_oceanbase_search_job_results_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test pipeline table compatibility with OceanBase
/// Order: 61, Dependencies: None
#[test]
fn test_oceanbase_pipeline_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test alert_dedup_state table compatibility with OceanBase
/// Order: 62, Dependencies: alerts
#[test]
fn test_oceanbase_alert_dedup_state_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test file_list_history table compatibility with OceanBase
/// Order: 63, Dependencies: None (file_list infrastructure)
#[test]
fn test_oceanbase_file_list_history_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test pipeline_last_errors table compatibility with OceanBase
/// Order: 64, Dependencies: pipelines (soft dependency)
#[test]
fn test_oceanbase_pipeline_last_errors_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test alert_incident_alerts table compatibility with OceanBase
/// Order: 65, Dependencies: alert_incidents
#[test]
fn test_oceanbase_alert_incident_alerts_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
...
/// Test report_dashboards table compatibility with OceanBase
/// Order: 66, Dependencies: reports, dashboards
#[test]
fn test_oceanbase_report_dashboards_compat() {
    TEST_RUNTIME.block_on(async {
        init_config_for_oceanbase_tests();
        let prefix = generate_test_prefix().await;
